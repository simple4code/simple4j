package com.simple4j.configurer.swagger;
...
public class SwaggerConfig {
    ...
    public Docket defaultApi2() {
        Docket docket = new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                //这里指定Controller扫描包路径
                .apis(RequestHandlerSelectors.basePackage("com.simple4j.demo"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .contact(new Contact("example", "http://demo.simple4j.com/", "simple4j@qq.com"))
                .version("1.0")
                .build();
    }
